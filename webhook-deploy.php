 ...
 *
 * Ajustar $secret y $venvActivate antes de subir este archivo al servidor.
 * $venvActivate es el "activate" del virtualenv que crea "Setup Python App"
 * de cPanel para esta aplicación (se ve en la sección "Virtual Environment"
 * de esa pantalla).
 */

$secret = 'CAMBIAR-ESTE-SECRETO';
$venvActivate = '/home/USUARIO/virtualenv/RUTA_APP/3.x/bin/activate';
